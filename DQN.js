...
const { randi, getopt } = require('./utils')
...
DQNAgent.prototype = {
  reset: function () {
    ...
    this.net = {}
    this.net.W1 = new R.RandMatrix(this.nh, this.ns, 0, 0.01)
    this.net.b1 = new Matrix(this.nh, 1, 0, 0.01)
    this.net.W2 = new R.RandMatrix(this.na, this.nh, 0, 0.01)
    this.net.b2 = new Matrix(this.na, 1, 0, 0.01)
